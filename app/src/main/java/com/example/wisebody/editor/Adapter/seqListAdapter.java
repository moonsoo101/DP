 ...
 */
public class seqListAdapter extends RecyclerView.Adapter<seqListAdapter.ViewHolder> {
    private List<seqData> items;
    ...
    public seqListAdapter(List<seqData> items, int itemLayout, EMVideoView preview, WebView webView, EditText writeSubtitle, Button pauseBtn, RecyclerView seqRecylcer, LinearLayout secCont, LinearLayout editmodeBtnCont) {
        this.items = items;
        this.itemLayout = itemLayout;
        this.preview = preview;
        this.webView = webView;
        this.writeSubtitle = writeSubtitle;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final seqData item = items.get(position);
        ...
        holder.seq_text.setText(item.text);
                ...
                holder.swipeCont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(selected_position!=-1) {
                            ...
                            writeSubtitle.setText(items.get(selected_position).text);
                            writeSubtitle.requestFocus();
                            mgr.showSoftInput(writeSubtitle, InputMethodManager.SHOW_FORCED);
                            preview.pause();
